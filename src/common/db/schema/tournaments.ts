...
export const stages = pgTable(
  ...
  (table) => [index('idx_stages_tournament_id').on(table.tournamentId)],
);
...
export const categories = pgTable(
  ...
  (table) => [
    ...
    index('idx_categories_stage_id').on(table.stageId),
  ],
);
...
export const groups = pgTable(
  ...
  (table) => [index('idx_groups_category_id').on(table.categoryId)],
);
